...
<body>
<form id="myForm" class="myForm" action="${basePath}/admin/carPosition_search.do" method="post">
	<ul class="breadcrumb">
		<li><i class="icon-home icon-2x"></i></li>
		<li>当前位置：车主监控  &gt; 车辆信息</li>
	</ul>
		...
		<div class="widget-content">
			<table class="table table-hover">
			  ...
			  <tr>
			  	  ...
			  	  <td>
			  	   <button type="button" onclick="view('${obdSN}')">查看</button>
