...
<body>
	<form name="myForm" id="myForm" action="obdServerParams_query.do" method="post" onsubmit="return formCheck();">
		<ul class="breadcrumb">
					...
					<tbody>
						<tr>
							...
							<td class="pn-fcontent">
								 <input type="text" size="24" id="obdSn" name="obdServerParams.obdSn" value="${obdServerParams.obdSn}" />
							</td>
							<th></th>
							<td class="pn-fcontent">
							</td>
		...
		<div class="widget widget-table">
			...
			<div class="widget-content widget-list">
				<table class="table table-striped table-bordered table-condensed table-hover sortable">
					...
					<tbody>
						<c:forEach items="${obdServerParamsList}" var="item" varStatus="status">
							<tr>
								<td>${item.id}</td>
								<td>${item.obdSn}</td>
