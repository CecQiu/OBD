...
function add(){
	var url="carOwnerService_peccancyAddJsp.do";
...
function del(){
	...
	url="carOwnerService_peccancyDel.do?idArr="+infoId;
...
function edit(){
	...
	if(length!=1){
		...
		var url="carOwnerService_peccancyEditJsp.do?id="+value;
		document.getElementById("editUser").style.display="";
		document.getElementById("iframe").src=url;
	}
...
<body>
<form id="myForm" class="myForm" action="carOwnerService_peccancySearch.do" method="post">
	<ul class="breadcrumb">
		<li><i class="icon-home icon-2x"></i></li>
		<li>当前位置：车主服务  &gt; 违章提醒</li>
	</ul>
		...
		<div class="widget-content">
			<table class="table table-hover">
			  <tr style="background-color: #c4e3f3;">
			  	<td>选择</td><td>姓名</td><td>性别</td><td>手机号码</td><td>车牌号码</td><td>二维码</td><td>违章内容</td><td>扣分</td><td>违章时间</td>
			  </tr>
			  <s:iterator value="carViolationList" >
			  <tr>
			  <td width="10%" height="26" align="center"> 
				...
				<td>
			  	...
			  	<td>
			  	  	<s:property value="violationDesc"></s:property>
			  	</td>
			  	<td>
			  	  	<s:property value="penaltyPoints"></s:property>
			  	</td>
			  	<td>
			  	  	<s:property value="violationTime"></s:property>
			  	</td>
			  </tr> 
			  </s:iterator>
			</table>
