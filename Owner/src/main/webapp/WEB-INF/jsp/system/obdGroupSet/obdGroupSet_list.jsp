...
<body>
	<form name="myForm" id="myForm" action="obdGroupSet_query.do" method="post">
		<ul class="breadcrumb">
		...
		<div class="widget widget-table">
			<div class="widget-content">
				...
				<div class="widget-bottom">
					<center>
						<input class="btn btn-primary pull-center" type="button" value="添加分组" onclick="toOdbGroupSet();"/>&nbsp;
					...
					<tbody>
						<c:forEach items="${obdStockInfos}" var="item" varStatus="status">
							<tr onclick="getRowIndex(this)">
								...
								<td>
									<a href="javascript:edit('${item.stockId}',${pager.pageSize},${pager.currentPage});" class="btn btn-info"><i class="icon-pencil"></i>&nbsp;&nbsp;修改分组编号</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
