 ...
 * 
 * 修改人：fdf
 * 修改时间2015-4-8 15:39:00
 * 修改的代码原型-$crossFrame:true,修改后为$crossFrame:false,
 * 修改原因：WdatePicker IE下报错： SCRIPT70: 没有权限
 */
...
$(function(){
	if($("#f_date1").val() == "" || $("#f_date2").val() == ""){
		...
		if($("#f_date1").val() == ""){
			...
			$("#f_date1").val(strYear+"-"+strMonth+"-"+strDay + " " + clock);
		}
		if($("#f_date2").val() == ""){
			$("#f_date2").val(yy + "-" + mm + "-" + dd + " " + clock);
		}
	}
});
