...
public class SecretUtils {
	...
	public static void main(String[] args) {
		String key = "yA/wzbbetv5rm+7#RM5OJ9ir";
		String msg = "111111";
		System.out.println("【加密前】：" + msg);

		// 加密
		byte[] secretArr = SecretUtils.encryptMode(msg.getBytes(), key);
		System.out.println("【加密后】：" + Base64.encode(secretArr));

		// 解密
		byte[] myMsgArr = SecretUtils.decryptMode(secretArr, key);
