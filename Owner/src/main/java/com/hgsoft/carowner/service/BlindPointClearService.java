 ...
 */
@Service
public class BlindPointClearService {
	private final Log logger = LogFactory.getLog(BlindPointClearService.class);
	@Resource
	DictionaryService  dictionaryService;
//	@Resource
//	private MsgSendUtil msgSendUtil;
	
	public String blindPointClear(String obdSn) {
		MsgSendUtil msgSendUtil = new MsgSendUtil();
		//获取命令字
		Dictionary dic=dictionaryService.getDicByCodeAndType("owner.command", "server.blindDataClear");
		//获取流水号
		...
		logger.info(resultStr+"*************************8017客户端响应结果");
		if(resultStr!=null){
