 ...
 */
@Service
public class OBDStudyService {
	private final Log logger = LogFactory.getLog(OBDStudyService.class);
...
//	private MsgSendUtil msgSendUtil;
	...
	public String obdStudy(String obdSn){
		MsgSendUtil msgSendUtil = new MsgSendUtil();
		//获取命令字
		Dictionary dic=dictionaryService.getDicByCodeAndType("owner.command", "server.OBDStudy");
		//获取流水号
		...
		logger.info(resultStr+"*************************8013客户端响应结果");
		if(resultStr!=null){
