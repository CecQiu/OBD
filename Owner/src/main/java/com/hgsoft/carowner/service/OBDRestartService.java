 ...
 */
@Service
public class OBDRestartService {
	private final Log logger = LogFactory.getLog(OBDRestartService.class);
	@Resource
	DictionaryService  dictionaryService;
//	@Resource
//	private MsgSendUtil msgSendUtil;
	
	public String OBDRestart(String obdSn){
		MsgSendUtil msgSendUtil = new MsgSendUtil();
		Dictionary dic=dictionaryService.getDicByCodeAndType("owner.command", "server.obdRestart");
		//获取流水号
		...
		logger.info(resultStr+"*************************8012客户端响应结果");
		if(resultStr!=null){
