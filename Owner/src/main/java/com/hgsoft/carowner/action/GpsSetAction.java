...
@Controller
@Scope("prototype")
public class GpsSetAction extends BaseAction {
	private final Log logger = LogFactory.getLog(GpsSetAction.class);
	private String starTime;
	private String endTime;
	
	private GpsSet gpsSet;
	private List<GpsSet> gpsSets = new ArrayList<GpsSet>();
	@Resource
...
//		obdPackets = obdPacketService.findByPager(pager, Order.desc("insertTime"));
	...
	public String query() {
		...
		gpsSets = gpsStateSetService.findByPager(pager,Order.desc("createTime"), propertyArr);
		return "list";
	}
	...
	public GpsSet getGpsSet() {
		return gpsSet;
	}


	public void setGpsSet(GpsSet gpsSet) {
		this.gpsSet = gpsSet;
	}


	public List<GpsSet> getGpsSets() {
		return gpsSets;
	}


	public void setGpsSets(List<GpsSet> gpsSets) {
		this.gpsSets = gpsSets;
	}
