...
@Controller
@Scope("prototype")
public class DomainStateAction extends BaseAction {
	private String starTime;
	private String endTime;
	
	private DomainState domainState;
	private List<DomainState> domainStateList = new ArrayList<DomainState>();
	@Resource
...
//		obdPackets = obdPacketService.findByPager(pager, Order.desc("insertTime"));
	...
	public String query() {
		...
		String obdSn = domainState.getObdSn();
		...
		domainStateList = domainStateService.findByPager(pager,null, propertyArr);
		return "list";
	}
