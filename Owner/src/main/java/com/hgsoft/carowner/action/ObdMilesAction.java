...
@Controller
@Scope("prototype")
public class ObdMilesAction extends BaseAction {
	private String startTime;
	private String endTime;
	
	private String obdSn;
	private String obdMSn;
	private List<ObdMiles> obdMilesList = new ArrayList<ObdMiles>();
	@Resource
...
//		obdPackets = obdPacketService.findByPager(pager, Order.desc("insertTime"));
	...
	public String query() {
		...
		obdMilesList=obdMilesService.queryByParams(pager, map);
	...
	public List<ObdMiles> getObdMilesList() {
		return obdMilesList;
	}


	public void setObdMilesList(List<ObdMiles> obdMilesList) {
		this.obdMilesList = obdMilesList;
	}
