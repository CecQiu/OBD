...
public class PortalAction extends BaseAction {
	private final Log logger = LogFactory.getLog(PortalAction.class);
...
//		obdPackets = obdPacketService.findByPager(pager, Order.desc("insertTime"));
	...
	public String query() {
		...
		String obdSn = portal.getObdSn();
		String type = portal.getType();
		String valid = portal.getValid();
		...
		portals = protalService.findByPager(pager,Order.desc("createTime"), propertyArr);
		return "list";
	}
