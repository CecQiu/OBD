...
@Controller
@Scope("prototype")
public class ObdTimeParamsAction extends BaseAction {
	private final Log logger = LogFactory.getLog(ObdTimeParamsAction.class);
	private String starTime;
	private String endTime;

	private OBDTimeParams obdTimeParams;
	private List<OBDTimeParams> obdTimeParamsList = new ArrayList<OBDTimeParams>();
	@Resource
...
//		obdPackets = obdPacketService.findByPager(pager, Order.desc("insertTime"));
	...
	public String query() {
		...
		String obdSn = obdTimeParams.getObdSn();
		...
		obdTimeParamsList = obdTimeParamsService.findByPager(pager,Order.desc("createTime"), propertyArr);
		return "list";
	}
	...
	public List<OBDTimeParams> getObdTimeParamsList() {
		return obdTimeParamsList;
	}


	public void setObdTimeParamsList(List<OBDTimeParams> obdTimeParamsList) {
		this.obdTimeParamsList = obdTimeParamsList;
	}
