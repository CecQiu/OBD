...
@Controller
@Scope("prototype")
public class ObdTravelParamsAction extends BaseAction {
	private final Log logger = LogFactory.getLog(ObdTravelParamsAction.class);
	private String starTime;
	private String endTime;

	private OBDTravelParams obdTravelParams;
	private List<OBDTravelParams> obdTravelParamsList = new ArrayList<OBDTravelParams>();
	@Resource
...
//		obdPackets = obdPacketService.findByPager(pager, Order.desc("insertTime"));
	...
	public String query() {
		...
		String obdSn = obdTravelParams.getObdSn();
		...
		obdTravelParamsList = obdTravelParamsService.findByPager(pager,Order.desc("createTime"), propertyArr);
		return "list";
	}
	...
	public List<OBDTravelParams> getObdTravelParamsList() {
		return obdTravelParamsList;
	}


	public void setObdTravelParamsList(List<OBDTravelParams> obdTravelParamsList) {
		this.obdTravelParamsList = obdTravelParamsList;
	}
